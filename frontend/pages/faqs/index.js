        ...
        <div className='mx-auto max-w-[1078px] pt-[50px]'>
          ...
          >
            ...
            <Collapse in={isOpen2} className='pt-2 pl-7'>
              ...
              <ul className='flex flex-col list-disc pl-5 text-18 gap-2 pt-2'>
                ...
                <li>If you approve the purchase, EDA automatically transfers the domain to the buyer and credits your wallet with the purchase amount instantly.</li>
              </ul>
          ...
          >
            ...
            <Collapse in={isOpen4} className='pt-2 pl-7'>
              ...
              <ul className='flex flex-col list-disc pl-5 text-18 gap-2 pt-2'>
                ...
                <li>Provide the domain name and description and hit submit. The next page opens up if the domain is in the wallet used to connect to the EDA platform.</li>
          ...
          >
            ...
            <Collapse in={isOpen5} className='pt-2 pl-7'>
              <h4 className='text-22 font-semibold'>What is the fee structure of the EDA marketplace?</h4>
              <p className='pt-2  text-18 leading-[24px]'>
          ...
          >
            <div className='flex items-center justify-between gap-2'>
              <p className='para-24 font-semibold'>
                <span className=''>6.</span> QuickBuild —Web3 Website Builder
              </p>
          ...
          >
            ...
            <Collapse in={isOpen8} className='pt-2 pl-7'>
              <h4 className='text-22 font-semibold'>How does EDA guarantee platform security?</h4>
              <p className='pt-2  text-18 leading-[24px]'>
          ...
          >
            ...
            <Collapse in={isOpen9} className='pt-2 pl-7'>
              ...
              <p className='pt-2  text-18 leading-[24px]'>
                The EDA marketplace currently supports Metamask and the WalletConnect integration available on most popular <Link className='text-white underline hover:text-white hover:opacity-60' href={'/'}> Web3 wallets</Link> including Coinbase and Trust Wallet.
              </p>
