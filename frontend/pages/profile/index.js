...
const Profile = () => {
 ...
 <section
        ...
        >
          ...
          <div className="col-span-1 overflow-hidden rounded-l-xl border-r-2 border-white">
                <div className="flex h-full flex-col justify-between overflow-hidden rounded-l-xl bg-primary-newBgColor/50 py-2 px-4  lg:py-6">
                  <div className="">
                    <h4 className="lg:heading-6 text-center lg:text-15 text-white">
                    {`Wallet: ${userInfo.name}`}
                    </h4><br/>
                    <div className="ml-[200px] h-[30px] w-[30px]">
                        <Image
                        src={beginner}
                        width={30}
                        height={30}
                    ...
                    <Image
                      ...
                      onError={setImgError}
                      alt="profile picture"
                      className="mx-auto md:mx-0 w-[200px] h-[200px] object-contain rounded-full shadow-2xl shadow-blue-200/50"
                      width={200}
                      height={200}
                                      />  
                     </div>                  
                  ...
                  <br/>
                <div className="mx-auto w-full max-w-[150px] ml-[135px]">
                    <a
                      href="users/me/edit"
                      className="flex w-full text-center rounded-full px-5 py-5 pl-9 text-14 text-blue-400 bg-primary-newBgColor/90 mt-8"
                    >
              ...
              <div className="col-span-1 overflow-hidden rounded-r-xl border-l-1 border-white">
                    ...
                    <div className="mx-auto w-full max-w-[250px] ml-[105px]">
                        <a
                        href="#benefit"
                        className="flex w-full text-center rounded-full px-8 py-5 pl-5 text-14 text-blue-400 lg:text-15 bg-primary-newBgColor/90"
                        >
                        My Websites
                        </a>
                    </div>
                    ...
                    <div className="mx-auto w-full max-w-[250px] ml-[105px]">
                        <a
                        href="#benefit"
                        className="flex w-full text-center rounded-full px-8 py-5 pl-5 text-14 text-violet-500 lg:text-15 bg-primary-newBgColor/90"
                        >
                        My Domains
                        </a>
                    </div>
                    ...
                    <div className="mx-auto w-full max-w-[250px] ml-[105px]">
                        ...
                        <a
                        href="#benefit"
                        className="flex w-full text-center rounded-full px-8 py-5 pl-20 text-14 text-white-300 lg:text-15 bg-primary-newBgColor/90"
                        >
                        User Reviews
                        </a>
                    </div>
