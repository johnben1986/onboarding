        ...
        <div className="flex h-screen">
          ...
          <div className="w-full flex-1">
            <header className="flex h-auto border-b border-white p-3 text-white md:h-[81px] md:p-4">
              <div className="container mx-auto flex flex-col items-center justify-between gap-4 px-0 md:flex-row">
                <div className="flex w-full items-center justify-between space-x-2 md:w-auto">
                  ...
                  <span className="text-xl font-medium"> Quickbuild</span>
                </div>
                <div className="flex items-center">
                <Link href={'/quickbuild/quickbuild-tutorial'} className="flex lg:hidden justify-center text-20 bg-white py-1 px-1 text-black hover:text-black rounded-3xl border border-black mr-2">{reactIcons.info}</Link>
                ...
                <Link href={'/quickbuild/quickbuild-tutorial'} className="hidden lg:flex w-[140px] justify-center bg-white py-2 px-3 text-black hover:text-black rounded-3xl border border-black mr-2">Info</Link>
            ...
            <div
              ...
              id="scrrolledDiv"
            >
              <div className="m-auto my-6 min-w-[80%]">
                <video
                  className="m-auto max-h-[400px] max-w-[80%] rounded-3xl"
                  autoPlay
                  loop
                  // controls
                  muted
          ...
          <div className="flex flex-col items-center gap-10 lg:flex-row">
            ...
            <div className="w-full rounded-xl bg-brand-background p-6 text-center lg:w-1/2">
              ...
              <p className="break-words text-lg">
                ...
                necessary to join. Earn $10 every time a $49 QuickBuild website
                is ordered through your affiliate link. Second tier pays $2.50
                If you get a white label / rebranded QuickBuild API for your own
