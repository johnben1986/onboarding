...
export default function DomainPage({ domainInfoFromServer }) {
  ...
  const currencySelectorStyle =
    "px h-12 rounded-md border-0 bg-transparent py-0 pr-2 text-lg focus:outline-none";
  ...
  const orderList = (isOffer) => {
    ...
    return (
      <div className="mt-6 space-y-4 text-white lg:mt-0 lg:w-3/6 md:w-6/6">
        {isOffer ? (
          <>
            <div className="h-96 overflow-y-auto rounded-2xl border border-white p-4 text-center">
    ...
    <>
      ...
      <div className="bg-image5">
        ...
        <div className="container py-7">
          <div className="border border-white rounded-md w-full mb-5 text-white">
            <div className="lg:flex md:flex items-start">
              ...
              <div className="lg:w-[calc(100%-250px)] md:w-[calc(100%-250px)] sm:w[100%]">
                <div className="w-full">
                  ...
                  <div className="flex items-end">
                    <div className="w-4/6 text-center border border-white p-3 rounded-lg h-[100px]">
          ...
          <div className="border border-white rounded-md w-full p-3 mb-5">
            {currencies ? (
