    ...
    const FooterUl = [
        {
          ...
          linksArr: [
            ...
            // { title: "Team", path: "/trademarks" },
            // { title: "Mission", path: "/story" },
            // { title: "Partners", path: "/partners" },
            { title: "Become a Member", path: "/member" },
        ...
        },
        {
          ...
          linksArr: [
            ...
            { title: "Quickbuild", path: "/quickbuild" },
        ...
        },
        {
          head: "Social",
          linksArr: [
            { title: "Twitter", path: "https://twitter.com/i/flow/login?redirect_after_login=%2Fweb3onboard" },
            { title: "Discord", path: "" },
