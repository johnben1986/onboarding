...
const EditSellerPage = ({ userId }) => {
  ...
  const inputClassName = "mb-5 h-14 rounded border-none pl-5";
  return (
    <>
      <AuthenticatedFragment permission={"users:update"} owner={targetUser}>
        <main className="bg-image4 py-5">
          <h1 className="mb-5 text-center font-brand-heading text-3xl text-white">
            Edit Seller Info
          </h1>
          <div className="mx-2 mb-10 rounded-xl border-2 border-white bg-primary-newBgColor/40 p-6 text-white lg:mx-auto lg:w-1/2">
            <Form
              name="basic"
              initialValues={{
                remember: true,
            ...
            >
              ...
              <Form.Item
                label={<label className="text-lg text-white">E-mail</label>}
                name="email"
                rules={[
                  {
                    type: "email",
              ...
              <Form.Item
                label={<label className="text-lg text-white">Name</label>}
                name="name"
                rules={[
                  {
                    required: true,
              ...
              <Form.Item
                label={<label className="text-lg text-white">Profile picture</label>}
              ...
              <Form.Item
                label={<label className="text-lg text-white">Telegram</label>}
                name="telegram"
              >
                <Input className={inputClassName} />
              </Form.Item>
              <Form.Item
                label={<label className="text-lg text-white">Twitter</label>}
                name="twitter"
              >
                <Input className={inputClassName} />
              </Form.Item>
              <Form.Item
                label={<label className="text-lg text-white">Linkedin</label>}
                name="linkedin"
              >
                <Input className={inputClassName} />
              </Form.Item>
              <Form.Item
                label={<label className="text-lg text-white">Instagram</label>}
                name="instagram"
              >
                <Input className={inputClassName} />
              </Form.Item>
